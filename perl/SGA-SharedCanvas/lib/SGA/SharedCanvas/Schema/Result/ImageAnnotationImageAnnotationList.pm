use utf8;
package SGA::SharedCanvas::Schema::Result::ImageAnnotationImageAnnotationList;
...
SGA::SharedCanvas::Schema::Result::ImageAnnotationImageAnnotationList
...
=head1 TABLE: C<image_annotation_image_annotation_list>

=cut

__PACKAGE__->table("image_annotation_image_annotation_list");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CPiedvdnNs8TugYRAv+2QA
