...
/*
# SGA Shared Canvas v0.132600
#
# **SGA Shared Canvas** is a shared canvas reader written in CoffeeScript.
#
# Date: Thu Sep 12 11:54:27 2013 -0400
#
  ...
  (function($, MITHgrid) {
    ...
    return SGA.namespace("Reader", function(SGAReader) {
      ...
      SGAReader.namespace("Component", function(Component) {
              ...
              that.events.onMaxChange.addListener(function(n) {
                ...
                if ($(container).data("slider")) {
                  ...
                  $('.canvas').on("sizeChange", function(e, d) {
                    var $c, adjustment, example_res, r, res_h_perc, res_height, s_max, s_min, valPercent, _i, _len;

                    $c = $(container);
                    $c.height(d.h);
                    example_res = [1, 2, 4, 13, 25, 68, 100];
                    for (_i = 0, _len = example_res.length; _i < _len; _i++) {
                      r = example_res[_i];
                      res_height = $(container).height() / (pages + 1);
                      ...
                      $(container).append("<div style='bottom:" + (valPercent + adjustment) + "%; height:" + res_height + "px' class='res ui-slider-range ui-widget-header ui-corner-all'>&nbsp;</div>");
                    }
        ...
        return Component.namespace("ModeControls", function(ModeControls) {
