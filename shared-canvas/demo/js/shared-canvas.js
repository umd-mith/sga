...
#
# Date: Fri Oct 25 17:14:13 2013 -0400
#
          ...
          return Zone.initInstance = function() {
            ...
            return (_ref = MITHgrid.Presentation).initInstance.apply(_ref, ["SGA.Reader.Presentation.HTMLZone"].concat(__slice.call(args), [function(that, container) {
              ...
              return that.addLens('ImageViewer', function(innerContainer, view, model, id) {
                var baseURL, centerX, centerY, divHeight, divScale, divWidth, djatokaTileWidth, height, imgContainer, item, rendering, tempBaseURL, width, x, y, zoomLevel, _ref, _ref1, _ref2, _ref3;
                if (__indexOf.call(options.types || [], 'Image') < 0) {
                  return;
                }
                rendering = {};
                ...
                centerX = 0;
                centerY = 0;
                rendering.setCenterX = function(x) {};
                rendering.setCenterY = function(y) {};
                rendering.getCenterX = function() {
                  return centerX;
                };
                rendering.getCenterY = function() {
                  return centerY;
                };
                rendering.remove = function() {
                ...
                $.ajax({
                  ...
                  success: function(metadata) {
                    var baseZoomLevel, calcJP2KTileSize, calcTileSize, constrainCenter, i, imageURL, inDrag, original2screen, originalHeight, originalWidth, recalculateBaseZoomLevel, renderTile, renderTiles, screen2original, screenCenter, screenCoords, screenExtents, startCenterX, startCenterY, startX, startY, tiles, wrapWithImageReplacement, xTiles, yTiles, zoomLevels, _i;
                    ...
                    recalculateBaseZoomLevel = function() {
                      divWidth = $(container).width() || 1;
                      return baseZoomLevel = Math.ceil(-Math.log(divScale) / Math.log(2));
                    };
                    ...
                    screenCenter = function() {
                      return original2screen(centerX - originalWidth / 2, centerY - originalHeight / 2);
                    };
                    ...
                    constrainCenter = function() {
                      ...
                      if (originalHeight - br.top < centerY) {
                        return centerY = originalHeight - br.top;
                      }
                    };
                    ...
                    renderTile = function(o) {
                      ...
                      if (imgEl != null) {
                        ...
                        (function(imgEl) {
                          ...
                          imgEl.bind('mousemove', function(e) {
                            if (inDrag) {
                              return e.preventDefault();
                            }
                          });
                          imgEl.bind('mouseup', function(e) {
                            if (inDrag) {
                              return e.preventDefault();
                            }
                          });
                          return imgEl.bind('mousewheel', function(e) {
                            e.preventDefault();
                            inDrag = false;
                            z = rendering.getZoom();
                    ...
                    rendering.addCenterX = function(dx) {
                      return rendering.setCenterX(centerX + dx);
                    };
                    rendering.addCenterY = function(dy) {
                      return rendering.setCenterY(centerY + dy);
                    };
        ...
        Presentation.namespace("HTMLCanvas", function(Canvas) {
          return Canvas.initInstance = function() {
            ...
            return (_ref = MITHgrid.Presentation).initInstance.apply(_ref, ["SGA.Reader.Presentation.HTMLCanvas"].concat(__slice.call(args), [function(that, container) {
              var DivHeight, DivWidth, annoExpr, app, baseFontSize, canvasHeight, canvasWidth, dataView, marquee, marqueeHeight, marqueeLeft, marqueeTop, marqueeWidth, options, realCanvas, resizer, strokeW, updateMarque, viewEl, visiblePerc, _ref, _ref1;
              options = that.options;
              annoExpr = that.dataView.prepare(['!target']);
              container.css({
                'overflow': 'hidden'
              ...
              return that.events.onCanvasChange.addListener(function(canvas) {
                ...
                canvasWidth = ((_ref2 = item.width) != null ? _ref2[0] : void 0) || 1;
                canvasHeight = ((_ref3 = item.height) != null ? _ref3[0] : void 0) || 1;
                resizer();
                if (realCanvas != null) {
                  if (realCanvas.hide != null) {
                    realCanvas.hide();
