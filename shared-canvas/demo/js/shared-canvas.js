          ...
          return Zone.initInstance = function() {
            ...
            return (_ref = MITHGrid.Presentation).initInstance.apply(_ref, ["SGA.Reader.Presentation.Zone"].concat(__slice.call(args), [function(that, container) {
              ...
              that.addLens('Image', function(container, view, model, id) {
                var item, renderImage, rendering, svgImage;
        ...
        return Application.namespace("SharedCanvas", function(SharedCanvas) {
          SharedCanvas.initInstance = function() {
            ...
            return (_ref = MITHGrid.Application).initInstance.apply(_ref, ["SGA.Reader.Application.SharedCanvas"].concat(__slice.call(args), [function(that) {
              var currentSequence, extractSpatialConstraint, extractTextBody, extractTextTarget, manifestData, options, presentations, styleSource, textSource;
              options = that.options;
              presentations = [];
              ...
              extractTextTarget = function(item, annoItem, id) {
                var cssStyleItem, styleItem, target, _ref;
                if (id == null) {
                  return;
                }
                ...
                if (__indexOf.call(target.type, "oaSpecificResource") >= 0) {
                  ...
                  if ((annoItem.oastyledBy != null) && (target.oastyleClass != null)) {
                  ...
                  } else if (target.oahasStyle != null) {
              ...
              extractTextBody = function(item, id) {
                ...
                if (__indexOf.call(body.type, "oaSpecificResource") >= 0) {
                ...
                } else if (__indexOf.call(body.type, "cntContentAsText") >= 0) {
                  return item.text = body.cntchars[0];
                }
              };
              if (options.url != null) {
                return manifestData.importFromURL(options.url, function() {
                  ...
                  syncer.process(annos, function(id) {
                    ...
                    if (__indexOf.call(aitem.type, "scContentAnnotation") >= 0) {
                      extractTextTarget(item, aitem, (_ref = aitem.oahasTarget) != null ? _ref[0] : void 0);
                      ...
                      if (sgaTypes.length > 0) {
                        extractTextTarget(item, aitem, (_ref4 = aitem.oahasTarget) != null ? _ref4[0] : void 0);
                        item.type = sgaTypes;
                        array = textAnnos;
                      }
                    }
