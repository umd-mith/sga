...
#
# Date: Mon Oct 28 20:17:48 2013 -0400
#
  ...
  (function($, MITHgrid) {
    ...
    return SGA.namespace("Reader", function(SGAReader) {
      ...
      SGAReader.namespace("Presentation", function(Presentation) {
                ...
                rendering.afterLayout = function() {
                  ...
                  if (lastRendering != null) {
                    ...
                    if ((prevSibling != null) && prevSibling.size() > 0) {
                      ...
                      spacing = Math.floor(prevSibling.css('left')) || 0;
                    ...
                    if (neededSpace < 0) {
                      if ((prevSibling == null) || prevSibling.size() <= 0) {
                        ...
                        prevSiblings.each(function(i, x) {
                          return availableSpace += Math.floor($(x).css('left')) || 0;
                        });
                        ...
                        if (availableSpace > neededSpace) {
                          ...
                          prevSiblings.each(function(i, s) {
                            ...
                            oldLeft = Math.floor($(s).css('left')) || 0;
                            if (availableSpace > 0) {
        ...
        Presentation.namespace("HTMLZone", function(Zone) {
          return Zone.initInstance = function() {
            var args, _ref;
            args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
            return (_ref = MITHgrid.Presentation).initInstance.apply(_ref, ["SGA.Reader.Presentation.HTMLZone"].concat(__slice.call(args), [function(that, container) {
              ...
              that.addLens('TextContentZone', function(innerContainer, view, model, id) {
                var height, item, marquee, marqueeHeight, marqueeLeft, marqueeTop, marqueeWidth, rendering, rootEl, strokeW, text, textContainer, textDataView, updateMarque, visiblePerc, width, x, y, zoom, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
                if (__indexOf.call(options.types || [], 'Text') < 0) {
                  return;
                }
                rendering = {};
                ...
                updateMarque = function(z) {
                  ...
                  that.onDestroy(app.imageControls.events.onZoomChange.addListener(updateMarque));
                  return that.onDestroy(app.imageControls.events.onImgPositionChange.addListener(function(p) {
                ...
                that.onDestroy((_ref1 = app.imageControls) != null ? _ref1.events.onActiveChange.addListener(function(a) {
                  if (a) {
                    return $('.marquee').show();
                  } else {
                    return $('.marquee').hide();
                ...
                x = ((_ref2 = item.x) != null ? _ref2[0] : void 0) != null ? item.x[0] : 0;
                y = ((_ref3 = item.y) != null ? _ref3[0] : void 0) != null ? item.y[0] : 0;
                width = ((_ref4 = item.width) != null ? _ref4[0] : void 0) != null ? item.width[0] : options.width - x;
                height = ((_ref5 = item.height) != null ? _ref5[0] : void 0) != null ? item.height[0] : options.height - y;
                $(textContainer).css({
                  left: Math.floor(16 + x * that.getScale()) + "px",
                  top: Math.floor(y * that.getScale()) + "px",
                  width: Math.floor(width * that.getScale()) + "px",
                ...
                rendering.update = function(item) {
                  ...
                  x = ((_ref6 = item.x) != null ? _ref6[0] : void 0) != null ? item.x[0] : 0;
                  y = ((_ref7 = item.y) != null ? _ref7[0] : void 0) != null ? item.y[0] : 0;
                  width = ((_ref8 = item.width) != null ? _ref8[0] : void 0) != null ? item.width[0] : options.width - x;
                  height = ((_ref9 = item.height) != null ? _ref9[0] : void 0) != null ? item.height[0] : options.height - y;
                  that.setHeight(height);
              ...
              return that.addLens('ImageViewer', function(innerContainer, view, model, id) {
                var baseURL, divHeight, divScale, divWidth, djatokaTileWidth, height, imgContainer, item, offsetX, offsetY, rendering, tempBaseURL, width, x, y, zoomLevel, _ref, _ref1, _ref2, _ref3;
                if (__indexOf.call(options.types || [], 'Image') < 0) {
                  return;
                }
                rendering = {};
                ...
                $.ajax({
                  ...
                  success: function(metadata) {
                    ...
                    calcTileSize = function() {
                      return Math.floor(Math.pow(2.0, zoomLevel) * divScale * calcJP2KTileSize());
                    };
                    ...
                    constrainCenter = function() {
                      ...
                      if (zoomLevel === 0) {
                        ...
                        if (offsetY < -originalHeight + sizes.top) {
                          return offsetY = -originalHeight + sizes.top;
                        }
                      }
                    };
                          ...
                          */
                          ...
                          return imgEl.bind('mousewheel DOMMouseScroll MozMousePixelScroll', function(e) {
                            ...
                            if (z >= 0 && z <= zoomLevels - baseZoomLevel) {
                              return rendering.setZoom((z + 1) * (1 + e.originalEvent.wheelDeltaY / 500) - 1);
                            }
                          });
                        })(imgEl);
                      }
        ...
        Presentation.namespace("Canvas", function(Canvas) {
          return Canvas.initInstance = function() {
            var args, _ref;
            args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
            return (_ref = SGA.Reader.Presentation.HTMLCanvas).initInstance.apply(_ref, args);
          };
        });
        Presentation.namespace("HTMLCanvas", function(Canvas) {
          return Canvas.initInstance = function() {
            var args, _ref;
            args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
            return (_ref = MITHgrid.Presentation).initInstance.apply(_ref, ["SGA.Reader.Presentation.HTMLCanvas"].concat(__slice.call(args), [function(that, container) {
              ...
              $(container).on("resetPres", function() {
                ...
                $(viewEl).empty();
                return realCanvas = SGA.Reader.Presentation.HTMLZone.initInstance(viewEl, {
                  types: options.types,
                  dataView: dataView,
                  application: options.application,
                  height: canvasHeight,
        ...
        return Presentation.namespace("SVGCanvas", function(Canvas) {
          return Canvas.initInstance = function() {
            var args, _ref;
            args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
            return (_ref = MITHgrid.Presentation).initInstance.apply(_ref, ["SGA.Reader.Presentation.SVGCanvas"].concat(__slice.call(args), [function(that, container) {
                ...
                syncer.done(function() {
                  ...
                  return that.dataStore.data.loadItems(items, function() {
                    ...
                    setMod = function(item) {
                      var end, id, indent, source, start, _base, _base1;
                      indent = item.indent;
                      source = item.target;
                      start = item.start;
                      end = item.end;
                    ...
                    _fn = function(source) {
                      return that.withSource(source, function(text) {
                        var br_pushed, id, idx, indent, last_pos, makeLinebreak, makeTextItems, mends, modIds, mstarts, needs_br, p, pos, positions, processNode, pushTextItem, textItems, _k, _l, _len2, _len3, _len4, _m, _ref, _ref1;
                        textItems = [];
                        modIds = [];
                        br_pushed = false;
                        pushTextItem = function(classes, css, target, start, end, indent) {
                          var titem;
                          if (indent == null) {
                            indent = null;
                          }
                        ...
                        makeTextItems = function(start, end, classes, css, indent) {
                        ...
                        makeLinebreak = function(pos, indent) {
                          var classes;
                          classes = ["LineBreak"];
                          return makeTextItems(pos, pos, classes, [""], indent);
                        };
